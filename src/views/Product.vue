            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="product-pic-zoom">
                  <img class="product-big-img" :src="gambar_defaults" alt="" />
                </div>
                <div class="product-thumbs">
                  ...
                  >
                    <div
                      ...
                      :class="thumbs[0] == gambar_defaults ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[1] == gambar_defaults ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[2] == gambar_defaults ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[3] == gambar_defaults ? 'active' : ''"
                    >
...
import Header from "@/components/HeaderKutg.vue";

import FooterKutg from "@/components/FooterKutg";

import RelatedKutg from "@/components/RelatedKutg";
...
export default {
  ...
  data() {
    return {
      gambar_defaults: "img/mickey1.jpg",
      thumbs: [
        "img/mickey1.jpg",
        "img/mickey2.jpg",
        "img/mickey3.jpg",
